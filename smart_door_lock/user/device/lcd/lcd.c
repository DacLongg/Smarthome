...
extern void Publish_door(char *state);
...
Screen_func_t Screen_Func[5] = {
	SetUp_password_screen,
	Enter_password_screen,
	Change_password_screen,
	Reg_fingerPrint_screen,
	Unlock_screen,
};

uint8_t ENB_Dislay = 0;
...
void LCD_task(void *pvParameters)
{
	...
	EventBits_t waitEndEvent;

    for( ;; )
    {
		waitEndEvent  =  xEventGroupWaitBits ( LCD_EventGroup, 
				END_PROCESS,
				pdTRUE, 
				pdFALSE, 
				portMAX_DELAY );
